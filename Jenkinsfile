...
//     IMAGE_NAME = "dnezdev" + "/" + "jobber-auth"
...
//         git branch: 'main', credentialsId: 'github', url: 'https://github.com/dnezdev/3-auth-service'
//         sh 'npm install'
//       }
//     }
        ...
        stage("Create New Pods") {
            steps {
                withKubeCredentials(kubectlCredentials: [[
                                                          ...
                                                          contextName: 'minikube',
                                                          credentialsId: 'jenkins-k8s-token',
                                                          namespace: 'YOUR_NAMESPACE', // Replace YOUR_NAMESPACE with the correct namespace
                                                          serverUrl: 'https://172.30.236.77:8443']]) {
                    script {
                        def pods = groovyMethods.findPodsFromName("${namespace}", "${serviceName}")
                        for (podName in pods) {
